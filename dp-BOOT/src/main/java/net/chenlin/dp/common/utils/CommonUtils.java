...
public class CommonUtils {
	 ...
	 * @throws IOException
	 */
	public static String generate(String templateClassPath, Map<String, Object> bindAttrs)
			throws IOException {
		ClasspathResourceLoader classpathResourceLoader =
				new ClasspathResourceLoader(getPath(templateClassPath));
	 ...
	 * @throws IOException
	 */
	public static void generate(String templateFilePath, String outputFilePath,
			Map<String, Object> bindAttrs) throws IOException {
